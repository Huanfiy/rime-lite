...
- OQ-2：AI 候选 daemon 的延迟模型与 Lua socket 可行性（不阻塞现有功能；推导见 [docs/notes/analysis/2026-07-01-architecture-open-questions.md](docs/notes/analysis/2026-07-01-architecture-open-questions.md)）。
